...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Digital Archive System | CMU</title>
    ...
    <script src="https://kit.fontawesome.com/26aded0b1b.js" crossorigin="anonymous"></script>
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        @include('layouts.general.mobile-header')
    </div>
    <!--end::Header Mobile-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            <!--begin::Header-->
            @include('layouts.user-panel.header')
            <!--end::Header-->
            ...
            <!--begin::Nav-->
            @include("layouts.user-panel.nav")
            <!--end::Nav-->
        </div>
        <!--end::Content-->
    </div>
